...
// anti-censorship), Routing profiles, Advanced (networking internals and
// the client's own DNS) and Versions (what is installed, read-only). The
// profile picker and the DNS upstream write endpoint options from their
// host tabs via ucisection.
